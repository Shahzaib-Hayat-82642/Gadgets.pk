...
<head>
    ...
    <title>Gadgets.pk</title>
    <link rel="stylesheet" href="BOOTSTRAP/css/bootstrap-337.min.css">
    <link rel="stylesheet" href="BOOTSTRAP/font-awsome/css/font-awesome.min.css">
                           ...
                           <form action="details.php?add_cart=<?php echo $product_id; ?>" class="form-horizontal" method="post"><!-- form-horizontal Begin -->
                               ...
                               <div class="form-group"><!-- form-group Begin -->
                                   ...
                                   <div class="col-md-7"><!-- col-md-7 Begin -->
                                       ...
                                       <select name="product_size" class="form-control" required oninput="setCustomValidity('')" oninvalid="setCustomValidity('Must pick 1 color for the product')"><!-- form-control Begin -->
